$(function () {
	...
	if (currentPage === "html_css" && Number.isInteger(currentPageNumber)) {
		...
		$(".container").append('<aside><p><a href="1.html">مدخل إلى Git و GitHub</a></p><p><a href="2.html">ورشة عمل git commit و git push</a></p><p><a href="3.html">خلاصة الدرس الأول و الثاني GIT</a></p><p><a href="4.html">إستنساخ cloning</a></p><p><a href="5.html">Pull & Conflicts</a></p></aside>');
